...
URL Source: https://htmx.org/docs/
...
Download `htmx.min.js`[from jsDelivr](https://cdn.jsdelivr.net/npm/htmx.org@2.0.6/dist/htmx.min.js) and add it to the appropriate directory in your project and include it where necessary with a `<script>` tag:
...
### [](https://htmx.org/docs/#the-hx-on-attributes)[](https://htmx.org/docs/)[The `hx-on*` Attributes](https://htmx.org/docs/#hx-on)
