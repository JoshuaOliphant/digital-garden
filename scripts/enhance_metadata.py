...
class MetadataEnhancer:
    ...
    def _needs_update(self, file_path: str) -> bool:
        ...
        return file_mtime > last_enhanced or \
               datetime.now() - last_enhanced > timedelta(days=7)
                ...
                if content.startswith('---'):
                    ...
                    if 'series' in metadata and metadata['series']:
                        for other_file in self.content_graph.nodes():
                            other_metadata = self.content_graph.nodes[other_file]['metadata']
            ...
            with Progress(
                ...
                for content_dir in glob.glob(f"{CONTENT_DIR}/*"):
                    ...
                    task_id = progress.add_task(
                        f"Enhancing {content_type} content...",
                        total=None
                    )
